...
public class SaveJPEGs {
   ...
   */
  public static void swf2JPEGs(String swfPath, String imgPath) throws IOException {
    jpegCounter = 100001;
    File sourceFile = new File(swfPath);
    outputDir = imgPath;
    // System.out.println("From File: " + sourceFile);
    // System.out.println("To Directory: " + outputDir);
